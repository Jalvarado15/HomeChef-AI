...
//  GeminiAIService, permite eliminar recetas guardadas, y ahora maneja el
//  caso de inventario vacío: si no hay ingredientes, no se llama a la API y
//  se muestra un alert amigable con acceso directo para agregar productos.
//
